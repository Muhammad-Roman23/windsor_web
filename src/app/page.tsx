    ...
    <main>
      <Sections>
        ...
        <StartSourcingCTA
          ...
          paragraph1="Whether you need one specific vehicle or regular stock for your dealership, Windsor Auto Group can help you find the right cars from the Japanese market."
          paragraph2="Tell us what you are looking for and start sourcing with a team focused on dealers and importers."
          buttonText="Start Sourcing From Japan"
