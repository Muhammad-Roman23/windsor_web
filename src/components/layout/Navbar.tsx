    ...
    <>
      <header
        className={`nav-section left-0 right-0 z-50 transition-[background-color,box-shadow,backdrop-filter] duration-300 ${
          ...
          fixed
            ? "border-b border-secondary/10 bg-main/90 shadow-[0_10px_40px_color-mix(in_srgb,var(--color-main)_20%,transparent)] backdrop-blur-md"
      ...
      >
        <div className="mx-auto section-inner flex h-[var(--nav-height)] items-center justify-between">
          ...
          <a
            href="#top"
            className="font-heading text-lg font-semibold tracking-tight text-alt"
          >
            {site.name}
          ...
          >
            ...
            <span className="flex flex-col gap-1.5">
              <span
                className={`block h-px w-4 bg-alt transition ${
                  menuOpen
